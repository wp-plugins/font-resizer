...
The resizable content must be in a div with a id called "innerbody".

== Installation ==

1. Upload the directory `font-resizer` to the `/wp-content/plugins/` directory
...
= Are there some FAQ? =
Not yet, no. But feel free to contact us if you have a question!
